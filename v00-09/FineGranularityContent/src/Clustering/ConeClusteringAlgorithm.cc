...
StatusCode ConeClusteringAlgorithm::Run()
{
	...
	//std::cout << "Inside ConeClusteringAlgorithm::Run in calohits loop 1 current pseudoLayer " << pseudoLayer << std::endl;
	...
	//std::cout << "Inside ConeClusteringAlgorithm::Run in calohits second loop 2 current pseudoLayer " << pseudoLayer << std::endl;
	...
	//std::cout << "Inside ConeClusteringAlgorithm::Run in calohits second loop 3 current pseudoLayer " << pseudoLayer << std::endl;
    }
...
//    std::cout << "Inside ConeClusteringAlgorithm::SeedClustersWithTracks 1 " << std::endl;
    ...
    for (TrackList::const_iterator iter = pTrackList->begin(), iterEnd = pTrackList->end(); iter != iterEnd; ++iter)
    {
        ...
        {
	    //std::cout << "Inside ConeClusteringAlgorithm::SeedClustersWithTracks 2 in loop " << std::endl;
            useTrack = true;
        }
        else if ((1 == m_clusterSeedStrategy) && pTrack->IsProjectedToEndCap())
        {
	    //std::cout << "Inside ConeClusteringAlgorithm::SeedClustersWithTracks 3 in loop " << std::endl;
            useTrack = true;
        }
	    ...
	    //std::cout << "Inside ConeClusteringAlgorithm::SeedClustersWithTracks 4 in loop " << std::endl;
    ...
    ClusterVector &clusterVector) const
{
	...
	//std::cout << "Inside ConeClusteringAlgorithm::FindHitsInPreviousLayers 1 in first loop layersToStepBack "  << layersToStepBack << " GeometryHelper::GetHitTypeGranularity(pCaloHit->GetHitType())  " << GeometryHelper::GetHitTypeGranularity(pCaloHit->GetHitType()) << std::endl;
	    ...
	    //std::cout << "Inside ConeClusteringAlgorithm::FindHitsInPreviousLayers 2 in second loop  searchLayer "   <<  searchLayer << std::endl;
		...
		//std::cout << "Inside ConeClusteringAlgorithm::FindHitsInPreviousLayers 3 in second loop  searchLayer "   <<  searchLayer << std::endl;
	       ...
	       //std::cout << "Inside ConeClusteringAlgorithm::FindHitsInPreviousLayers 4 in second loop  searchLayer "   <<  searchLayer << " clusterEnergy " << clusterEnergy << " genericDistance  " << genericDistance << " bestClusterEnergy " << bestClusterEnergy << std::endl;
                if ((genericDistance < smallestGenericDistance) || ((genericDistance == smallestGenericDistance) && (clusterEnergy > bestClusterEnergy)))
                {
		  //std::cout << "Inside ConeClusteringAlgorithm::FindHitsInPreviousLayers 5 in second loop  searchLayer "   <<  searchLayer << std::endl;
            ...
            {
	       //std::cout << "Inside ConeClusteringAlgorithm::FindHitsInPreviousLayers 6 in second loop  searchLayer "   <<  searchLayer << std::endl;
        ...
        {
	    //std::cout << "Inside ConeClusteringAlgorithm::FindHitsInPreviousLayers 7 " << std::endl;
            PANDORA_RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, PandoraContentApi::AddCaloHitToCluster(*this, pBestCluster, pCaloHit));
        }
        ...
        {
	   //std::cout << "Inside ConeClusteringAlgorithm::FindHitsInPreviousLayers 8 " << std::endl;
...
//	std::cout << "Inside ConeClusteringAlgorithm::UpdateClusterProperties 1 nLayersSpanned " << nLayersSpanned << " inner layer " << innerLayer << " outer layer  " << outerLayer << std::endl;

        if (nLayersSpanned > m_nLayersSpannedForFit)
        {
//	    std::cout << "Inside ConeClusteringAlgorithm::UpdateClusterProperties 2 " << std::endl;
        ...
        {
	    //std::cout << "Inside ConeClusteringAlgorithm::UpdateClusterProperties 3 " << std::endl;
	...
	//std::cout << "Inside ConeClusteringAlgorithm::UpdateClusterProperties 4 " << std::endl;
...
//     std::cout << "Inside ConeClusteringAlgorithm::GetGenericDistanceToHit 1 " << std::endl;
...
// 	std::cout << "Inside ConeClusteringAlgorithm::GetGenericDistanceToHit 2 " << std::endl;

        return this->GetConeApproachDistanceToHit(pCaloHit, trackState.GetPosition(), trackDirection, genericDistance);
    }

//     std::cout << "Inside ConeClusteringAlgorithm::GetGenericDistanceToHit 3 " << std::endl;
...
StatusCode ConeClusteringAlgorithm::RemoveEmptyClusters(ClusterVector &clusterVector) const
{
    ...
    //std::cout << "Inside ConeClusteringAlgorithm::RemoveEmptyClusters 1 " << std::endl;  

    for (ClusterVector::iterator iter = clusterVector.begin(), iterEnd = clusterVector.end(); iter != iterEnd; ++iter)
    {
        //std::cout << "Inside ConeClusteringAlgorithm::RemoveEmptyClusters 2 in loop " << std::endl;  
        if (0 == (*iter)->GetNCaloHits())
        {
	   //std::cout << "Inside ConeClusteringAlgorithm::RemoveEmptyClusters 3 in loop  " << std::endl;  
    ...
    {  
        //std::cout << "Inside ConeClusteringAlgorithm::RemoveEmptyClusters 4   " << std::endl;  
...
StatusCode ConeClusteringAlgorithm::ReadSettings(const TiXmlHandle xmlHandle)
{
    ...
    m_shouldUseIsolatedHits = false; //Fix from NS from false to true // it was false for CMS detector
    PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=, XmlHelper::ReadValue(xmlHandle,
        "ShouldUseIsolatedHits", m_shouldUseIsolatedHits));

    m_layersToStepBackFine = 3;  //was 3
    PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=, XmlHelper::ReadValue(xmlHandle,
        "LayersToStepBackFine", m_layersToStepBackFine));

    m_layersToStepBackCoarse = 3;  //was 3
    PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=, XmlHelper::ReadValue(xmlHandle,
    ...
    m_genericDistanceCut = 1.f; //was 1.f NS fix // was 10.f to run in CMS detector     
    PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=, XmlHelper::ReadValue(xmlHandle,
    ...
    m_nLayersSpannedForFit = 6; //was 6
    PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=, XmlHelper::ReadValue(xmlHandle,
