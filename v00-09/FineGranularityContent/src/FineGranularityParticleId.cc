...
{
    //std::cout << " FineGranularityEmShowerId GeometryHelper::GetHitTypeGranularity(pCluster->GetInnerLayerHitType())  " << GeometryHelper::GetHitTypeGranularity(pCluster->GetInnerLayerHitType())  << " FINE " << FINE << std::endl;
    ...
    //std::cout << " FineGranularityEmShowerId GeometryHelper::GetHitTypeGranularity MIP FRACTIOn " << pCluster->GetMipFraction() << " MIP CUT " << mipCut << std::endl;
    ...
    //std::cout << " FineGranularityContent/src/FineGranularityParticleId  dCosR " << dCosR << " dCosR cut " << dCosRCut << std::endl;
    ...
    //std::cout << " FineGranularityContent/src/FineGranularityParticleId  clusterRms " << clusterRms << " rmsCut " <<  rmsCut << std::endl;
    ...
    for (PseudoLayer iLayer = innerPseudoLayer, outerPseudoLayer = pCluster->GetOuterPseudoLayer(); iLayer <= outerPseudoLayer; ++iLayer)
    {
        ...
        if (innerPseudoLayer == iLayer)
        {
            ...
            //std::cout << " EM SHOWER ID nRadiationLengths " << nRadiationLengths << " m_emShowerIdMaxInnerLayerRadLengths " << m_emShowerIdMaxInnerLayerRadLengths << std::endl;
        ...
        {
            foundLayer90 = true;
            //std::cout << " EM SHOWER ID nRadiationLengths " << nRadiationLengths << " m_emShowerIdMinLayer90RadLengths " << m_emShowerIdMinLayer90RadLengths << " m_emShowerIdMaxLayer90RadLengths " << m_emShowerIdMaxLayer90RadLengths << std::endl;
    ...
    //std::cout << " IN FineGranularityContent/src/FineGranularityParticleId ShowerMaxRadLengths " << showerMaxRadLengths << " m_emShowerIdMinShowerMaxRadLengths " << m_emShowerIdMinShowerMaxRadLengths << " m_emShowerIdMinShowerMaxRadLengths " << m_emShowerIdMinShowerMaxRadLengths << std::endl;

    if ((showerMaxRadLengths < m_emShowerIdMinShowerMaxRadLengths) || (showerMaxRadLengths > m_emShowerIdMaxShowerMaxRadLengths))
        return false;

   //std::cout << " IN FineGranularityContent/src/FineGranularityParticleId  energyAboveHighRadLengths " << energyAboveHighRadLengths << " m_emShowerIdMaxHighRadLengthEnergyFraction * totalElectromagneticEnergy " << m_emShowerIdMaxHighRadLengthEnergyFraction *  totalElectromagneticEnergy << std::endl;
   ...
   //std::cout << " RADIAL 90  " << radial90 << " m_emShowerIdMaxRadial90 " << m_emShowerIdMaxRadial90 << std::endl;
...
//    if(associatedTrackList.empty()) std::cout << " NO TRACK IN ELECTRON ID " << associatedTrackList.empty() << std::endl;
...
/*
  if(! associatedTrackList.empty() ){
    std::cout << " ELECTRON ID  I am getting in here 0 energy " << electromagneticEnergy <<   " m_electronIdMaxEnergy "  << m_electronIdMaxEnergy <<  std::endl;
    std::cout << " pCluster->GetInnerPseudoLayer() " << pCluster->GetInnerPseudoLayer() << " m_electronIdMaxInnerLayer " << m_electronIdMaxInnerLayer << std::endl;
    std::cout << " !FineGranularityParticleId::FineGranularityEmShowerId(pCluster) " << !FineGranularityParticleId::FineGranularityEmShowerId(pCluster) << std::endl;
  }
*/
  ...
  if(! associatedTrackList.empty() ){
    //std::cout << " ELECTRON ID  I am getting in here 1 " << std::endl;
 }
...
/*
  if(! associatedTrackList.empty() ){
    std::cout << " showerProfileDiscrepancy " << showerProfileDiscrepancy << " m_electronIdMaxProfileDiscrepancy " << m_electronIdMaxProfileDiscrepancy << std::endl;
    std::cout << " showerProfileDiscrepancy " <<  showerProfileDiscrepancy  <<  " m_electronIdProfileDiscrepancyForAutoId " << m_electronIdMaxProfileDiscrepancy << std::endl;
    std::cout << " showerProfileStart " << showerProfileStart << "  m_electronIdMaxProfileStart " <<  m_electronIdMaxProfileStart << std::endl;
 }
*/
  ...
  if(! associatedTrackList.empty() ){
    //std::cout << " ELECTRON ID  I am getting in here  3 showerProfileDiscrepancy " << showerProfileDiscrepancy << " m_electronIdProfileDiscrepancyForAutoId " << m_electronIdProfileDiscrepancyForAutoId <<  std::endl;
  }
  ...
  if(! associatedTrackList.empty() ){
    //std::cout << " ELECTRON ID  I am getting in here too E/P " << eOverP <<  " E "  << electromagneticEnergy << " p " << momentumAtDca << std::endl;
  }

        if (std::fabs(eOverP - 1.f) < m_electronIdMaxResidualEOverP || (eOverP - 1.f) >0) { // NS CHANGE
        //if (std::fabs(eOverP - 1.f) < m_electronIdMaxResidualEOverP) { 
        //std::cout << " FineGranularityContent/src/FineGranularityParticleId I am returning true due to E/P " << std::endl;
        return true;
        }       
    }
...
float FineGranularityParticleId::m_electronIdMaxProfileDiscrepancy = 0.9f; // 0.6 initially NS CHANGE // 0.7 as a first step
float FineGranularityParticleId::m_electronIdProfileDiscrepancyForAutoId = 0.9f; // 0.5 initially NS CHANGE
float FineGranularityParticleId::m_electronIdMaxResidualEOverP = 0.3f; // 0.2 NS CHANGE 
...
float FineGranularityParticleId::m_emShowerIdRmsCutEnergy = 70.f; // NS CHANGE 40.f
float FineGranularityParticleId::m_emShowerIdRmsLowECut = 70.f;   // NS CHANGE 40.f
...
float FineGranularityParticleId::m_emShowerIdMaxRadial90 = 40.f; // it was 40.f NS CHANGE
